...
def buildModel(embeddingMatrix, smileyEmbeddings):
    ...
    lstm_person1 = Bidirectional(LSTM(LSTM_DIM, dropout=DROPOUT, return_sequences=True))
    lstm_person2 = Bidirectional(LSTM(LSTM_DIM, dropout=DROPOUT, return_sequences=True))
