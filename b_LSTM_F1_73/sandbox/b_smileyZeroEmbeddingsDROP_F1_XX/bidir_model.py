...
def buildModel(embeddingMatrix, smileyEmbeddings):
    ...
    lstm = Bidirectional(LSTM(LSTM_DIM, dropout=DROPOUT,recurrent_dropout=DROPOUT, return_sequences=True))
    lstm_smiley = LSTM(LSTM_DIM, dropout=DROPOUT,recurrent_dropout=DROPOUT)
