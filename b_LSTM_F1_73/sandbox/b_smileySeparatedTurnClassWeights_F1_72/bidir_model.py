...
def main():
    ...
    weights = {3:0.3, 2:0.3, 1:0.3, 0:1.7}
    if EARLY_STOPPING=='True':
        ...
        history = model.fit([u1_data, u2_data, u3_data, s1_data, s2_data, s3_data], labels, validation_data=([u1_valData,u2_valData,u3_valData, s1_valData, s2_valData, s3_valData], validationLabels), epochs=NUM_EPOCHS, batch_size=BATCH_SIZE, verbose=2, callbacks=[es, mc],class_weight=weights)
    else:
        model = buildModel(embeddingMatrix, smileyEmbeddings)
