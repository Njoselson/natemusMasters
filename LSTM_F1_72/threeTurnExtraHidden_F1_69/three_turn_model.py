...
def buildModel(embeddingMatrix):
    ...
    hidden_layer = Dense(256, activation='relu')(concatenated_out)
...
def main():
    ...
    if EARLY_STOPPING=='True':
        ...
        history = model.fit([u1_data,u2_data,u3_data], labels, validation_data=([u1_valData,u2_valData,u3_valData], validationLabels), epochs=NUM_EPOCHS, batch_size=BATCH_SIZE, verbose=0, callbacks=[es, mc])
    else:
        model = buildModel(embeddingMatrix)
